...
const file_user_service_proto_user_user_proto_rawDesc = "" +
	"\n" +
	"\"user-service/proto/user/user.proto\x12\x04user\"@\n" +
	"\x04User\x12\x0e\n" +
	...
	".user.User\x12<\n" +
	"\tListUsers\x12\x16.user.ListUsersRequest\x1a\x17.user.ListUsersResponseBCZAgithub.com/kota/distributed-system-sample/user-service/proto/userb\x06proto3"

var (
	file_user_service_proto_user_user_proto_rawDescOnce sync.Once
	file_user_service_proto_user_user_proto_rawDescData []byte
)

func file_user_service_proto_user_user_proto_rawDescGZIP() []byte {
	file_user_service_proto_user_user_proto_rawDescOnce.Do(func() {
		file_user_service_proto_user_user_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_user_service_proto_user_user_proto_rawDesc), len(file_user_service_proto_user_user_proto_rawDesc)))
	})
	return file_user_service_proto_user_user_proto_rawDescData
}

var file_user_service_proto_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_user_service_proto_user_user_proto_goTypes = []any{
...
func file_user_service_proto_user_user_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_user_service_proto_user_user_proto_rawDesc), len(file_user_service_proto_user_user_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
